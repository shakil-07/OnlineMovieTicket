...
function validatePassword(){
	...
	if(checkUpperCase>0 && len>=8 && checkNumber>0)
		{
		...
		//if(password!=null && password!="")
			//{
		document.getElementById("password").innerHTML="Error! Atleast 8 characters needed. Your password should be alphanumeric. ";
