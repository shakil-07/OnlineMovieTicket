  ...
  <div class="shell">
    ...
    <div id="navigation">
      <ul>
        ...
        <li><a href="../register/register2.jsp" style="color:#F00"><center>REGISTER</center><em>be a member</em></a></li>
        <li><a href="../register/login2.jsp" style="color:#F00"><center>LOG IN</center><em>for existing users</em></a></li>
        <li class="last"><a href="contact.jsp" style="color:#F00"><center>CONTACT</center><em>get in touch</em></a></li>
      ...
      <div  class="form">
    		<form id="contactform" action="contactquery.jsp"> 
    			...
    			<input type="email" id="email1" name="email1"  placeholder="enter your email id" required> 
   				<input type="hidden" name="hide" value="index">
